...
const recompute = async () => {
    ...
    const costFor = (list, gov) => list?.find((c) => c.governorate === gov)?.cost ?? 0;
    let cursor = null;
    let scanned = 0;
    let changed = 0;
    for (;;) {
        ...
        for (const o of orders) {
            ...
            if (o.branchId === o.client.branchId) {
                ...
                const clientBranch = o.client.branchId
                    ...
                    : undefined;
                receivingBranchNet = costFor(orderBranch?.forwardedDeliveryCosts, o.governorate);
                forwardedProfit = costFor(clientBranch?.receivingDeliveryCosts, o.governorate);
            }
            // const differs =
        ...
        console.log(`[recompute] ${scanned} scanned / ${changed} ${DRY_RUN ? "would change" : "changed"}`);
...
//# sourceMappingURL=recomputeOrderProfits.js.map