...
router
    .route("/transactions/orders-by-branch")
    .get(isLoggedIn_1.isLoggedIn, (0, isAutherized_1.isAutherized)([client_1.EmployeeRole.COMPANY_MANAGER, client_1.EmployeeRole.BRANCH_MANAGER]), transactionsController.getOrdersByBranch);
router
...
router
    .route("/transactions/profits/by-branch")
    .get(isLoggedIn_1.isLoggedIn, (0, isAutherized_1.isAutherized)([client_1.EmployeeRole.COMPANY_MANAGER, client_1.EmployeeRole.BRANCH_MANAGER]), transactionsController.getStatisticsByBranch);
router
