...
router.route("/stores/:storeID").delete(isLoggedIn_1.isLoggedIn, (0, isAutherized_1.isAutherized)([client_1.AdminRole.ADMIN, client_1.AdminRole.ADMIN_ASSISTANT, client_1.EmployeeRole.COMPANY_MANAGER]), storesController.deleteStore
/*
    #swagger.tags = ['Stores Routes']
*/
);
...
router.route("/stores/:storeID/reactivate").patch(isLoggedIn_1.isLoggedIn, (0, isAutherized_1.isAutherized)([client_1.AdminRole.ADMIN, client_1.AdminRole.ADMIN_ASSISTANT, client_1.EmployeeRole.COMPANY_MANAGER]), storesController.reactivateStore
/*
    #swagger.tags = ['Stores Routes']
*/
);
