...
router.route("/reports/:reportID/deactivate").patch(isLoggedIn_1.isLoggedIn, (0, isAutherized_1.isAutherized)([client_1.EmployeeRole.COMPANY_MANAGER], [client_1.Permission.DELETE_DELIVERY_AGENT_REPORT]), reportController.deactivateReport);
