...
exports.reportsOrderReform = exports.reportsOrderSelect = void 0;
exports.reportsOrderSelect = {
    id: true,
    totalCost: true,
    paidAmount: true,
    deliveryCost: true,
...
const reportsOrderReform = (order) => {
    if (!order) {
        return null;
    }
    const orderReformed = {
        ...
        client: {
            ...
            deliveryAgentProfit: order.client.deliveryAgentProfit,
            forwardedBranchProfit: order.client.forwardedBranchProfit,
            receivingBranchProfit: order.client.receivingBranchProfit,
            mainBranchProfit: order.client.mainBranchProfit,
...
exports.reportsOrderReform = reportsOrderReform;
//# sourceMappingURL=reportsOrders.response.js.map