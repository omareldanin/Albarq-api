...
exports.generateOrdersReport = void 0;
...
const generateOrdersReport = async (type, ordersData, orders) => {
    try {
        let templatePath = "";
        if (type === "DELIVERY_AGENT_MANIFEST") {
            templatePath = node_path_1.default.join(__dirname, "../../../static/templates/deliveryAgentManifest.hbs");
        }
        else if (type === "GENERAL") {
            templatePath = node_path_1.default.join(__dirname, "../../../static/templates/ordersReport.hbs");
        }
        else {
...
//# sourceMappingURL=generateOrdersReport.js.map